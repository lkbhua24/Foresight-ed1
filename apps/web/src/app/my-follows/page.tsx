          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-[#F472B6]/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30 focus:border-transparent"
              />
            </div>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    className="w-full px-3 py-2 border border-[#F472B6]/60 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30"
                    >

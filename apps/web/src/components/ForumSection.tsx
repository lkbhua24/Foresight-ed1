...
const { account, connectWallet, formatAddress, siweLogin, requestWalletPermissions, multisigSign } = useWallet()
  ...
  return (
    <div className="rounded-2xl border border-[#F472B6]/60 bg-white/70 backdrop-blur overflow-hidden">
      ...
      <div className="p-4 space-y-6">
        <div className="bg-white/80 rounded-xl border border-[#F472B6]/60 p-4">
          {!account ? (
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <input value={subjectName} onChange={e => setSubjectName(e.target.value)} placeholder="主体名称"
                       className="w-full px-3 py-2 border border-[#F472B6]/60 rounded-xl bg-white/80 text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30" />
                <select value={actionVerb} onChange={e => setActionVerb(e.target.value)} className="w-full px-3 py-2 border border-[#F472B6]/60 rounded-xl bg-white/80 text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <input value={targetValue} onChange={e => setTargetValue(e.target.value)} placeholder="目标值/条件"
                       className="w-full px-3 py-2 border border-[#F472B6]/60 rounded-xl bg-white/80 text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30" />
                <input type="datetime-local" value={deadline} onChange={e => setDeadline(e.target.value)} className="w-full px-3 py-2 border border-[#F472B6]/60 rounded-xl bg-white/80 text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30" />
                <select value={category} onChange={e => setCategory(e.target.value)} className="w-full px-3 py-2 border border-[#F472B6]/60 rounded-xl bg-white/80 text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30">
              ...
              <div className="bg-white/70 border border-[#F472B6]/60 rounded-xl p-3 text-sm text-gray-800">
        ...
        <div className="space-y-4">
          ...
          {threads.map(t => (
            <div key={t.id} className="bg-white/80 rounded-xl border border-[#F472B6]/60 p-4">
  ...
  return (
    <div className="flex items-center gap-2">
      <input value={text} onChange={e => setText(e.target.value)} placeholder="写下评论…"
             className="flex-1 px-3 py-2 border border-[#F472B6]/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30 bg-white/80 text-gray-800" />

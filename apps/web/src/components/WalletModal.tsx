              ...
              <div className="relative p-6 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border-2 border-[#F472B6]/60 bg-white/95 px-3 py-2.5 text-base text-black placeholder:text-gray-400 focus:outline-none focus:ring-4 focus:ring-[#F472B6]/30 focus:border-[#F472B6]/60"
                  />
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border-2 border-[#F472B6]/60 bg-white/95 pl-10 pr-3 py-2.5 text-base text-black placeholder:text-gray-400 focus:outline-none focus:ring-4 focus:ring-[#F472B6]/30 focus:border-[#F472B6]/60"
                    />
                  </div>
                  ...
                  {otpRequested && (
                    <div className="space-y-2">
                      <input
                        ...
                        className="tracking-widest text-center text-lg w-full rounded-lg border border-[#F472B6]/60 px-3 py-2 text-black focus:outline-none focus:ring-2 focus:ring-[#F472B6]/30"
                        placeholder="••••••"
                      />
                      {codePreview && (
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setEmail(e.target.value)}
                      placeholder="name@example.com"
                      className="w-full rounded-xl border-2 border-[#F472B6]/60 bg-white/95 pl-10 pr-3 py-2.5 text-base text-black placeholder:text-gray-400 focus:outline-none focus:ring-4 focus:ring-[#F472B6]/30 focus:border-[#F472B6]/60 shadow-sm hover:border-[#F472B6]"
                      spellCheck={false}
                    />
                  </div>
              ...
              {availableWallets.map((wallet, index) => (
                <motion.button
                  ...
                  className={`
                    ...
                    ${wallet.isAvailable 
                      ? 'border-[#F472B6]/50 hover:border-[#F472B6] hover:bg-gradient-to-r hover:from-purple-50/50 hover:to-pink-50/50 cursor-pointer hover:shadow-lg' 
                      : 'border-gray-200/50 bg-gray-50/50 opacity-60'
                    }
                    ${selectedWallet === wallet.type ? 'border-[#F472B6] bg-gradient-to-r from-purple-100/50 to-pink-100/50 shadow-lg' : ''}
                  `}
                ...
                >
                  ...
                  <div className="relative">
                    {selectedWallet === wallet.type && (isConnecting || siweLoading || permLoading || multiLoading) ? (
                      ...
                      <div className="w-6 h-6 rounded-full border-2 border-[#F472B6]/60 group-hover:border-[#F472B6] transition-colors duration-300 flex items-center justify-center">
                        <div className="w-2 h-2 rounded-full bg-[#F472B6] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                      </div>
                    ) : (
